    ...
    <div className="mx-auto flex max-w-content flex-col gap-8 px-margin-mobile py-12 md:px-margin-desktop">
      <div className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-body-lg text-on-surface-variant">
          Sept dîners 100% végétariens, pour la plupart vegan, pensés pour une famille de 5 — mais
          tout aussi bons à deux ou à quatre. Aucune recette n'est verrouillée.
        </p>
      </div>
